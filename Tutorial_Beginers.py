...
# Tuples : 1 loại của cấu trúc dữ liệu ( về cơ bản là 1 nơi có thể lưu trữ cấu trúc dữ liệu) 
#.Tuples Bất biến không thể thay đổi đc
toado =(4,5)
print(toado[0])
...
#  tạo hàm. cho biến result =1 chạy vl for theo biến lũy thừa. 
# gán hàm result bằng result nhân với cơ số.
# Sau đó return trở lại để bắt đầu theo biến result bằng 1 mới. 
# In kết quả của hàm với cơ số và số mũ
...
# Reading files
  ...
  #r: doc file w: ghi, thay doi thong tin file a: cơ bản là cây bút: 
  # nối thêm thông tin ở cuối tệp  r+ :đọc và viết
